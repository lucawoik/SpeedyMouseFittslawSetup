...
void initSettings()
{
    ...
    char* model_paths[] = {"models/ANN_60ms_20_removed_events/", "models/ANN_40ms_5", "models/ANN_20ms_5", "models/ANN_60ms_5", "models/ANN_60ms_5", "models/ANN_60ms_5", "models/ANN_60ms_5"};
