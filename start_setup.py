...
# LATENCY_CLICK_LOW = 80
# LATENCY_CLICK_HIGH = 160

# LATENCY_MOVE_LOW = 80
# LATENCY_MOVE_HIGH = 160

# VARIANCE_CLICK_LOW = 60
# VARIANCE_CLICK_HIGH = 120

# VARIANCE_MOVE_LOW = 60
# VARIANCE_MOVE_HIGH = 120
...
#             [LATENCY_CLICK_LOW, LATENCY_CLICK_LOW, 0, 0],
#             [LATENCY_CLICK_HIGH, LATENCY_CLICK_HIGH, 0, 0],
#             [LATENCY_CLICK_LOW - int(VARIANCE_CLICK_HIGH / 2), LATENCY_CLICK_LOW + int(VARIANCE_CLICK_HIGH / 2), 0, 0],
#             [LATENCY_CLICK_HIGH - int(VARIANCE_CLICK_HIGH / 2), LATENCY_CLICK_HIGH + int(VARIANCE_CLICK_HIGH / 2), 0, 0],
#             [LATENCY_CLICK_HIGH, LATENCY_CLICK_HIGH, LATENCY_MOVE_HIGH, LATENCY_MOVE_HIGH],
#             [LATENCY_CLICK_LOW, LATENCY_CLICK_LOW, LATENCY_MOVE_LOW, LATENCY_MOVE_LOW],
#             [LATENCY_CLICK_LOW - int(VARIANCE_CLICK_HIGH / 2), LATENCY_CLICK_LOW + int(VARIANCE_CLICK_HIGH / 2), LATENCY_MOVE_LOW - int(VARIANCE_MOVE_HIGH / 2), LATENCY_MOVE_LOW + int(VARIANCE_MOVE_HIGH / 2)],
#             [LATENCY_CLICK_HIGH - int(VARIANCE_CLICK_HIGH / 2), LATENCY_CLICK_HIGH + int(VARIANCE_CLICK_HIGH / 2), LATENCY_MOVE_HIGH - int(VARIANCE_MOVE_HIGH / 2), LATENCY_MOVE_HIGH + int(VARIANCE_MOVE_HIGH / 2)]]
...
while(True):
    ...
    for l in latencies:
        ...
        os.system('echo "{} {} {} {}" > /tmp/delaydaemon'.format(latencies[trial][0], latencies[trial][1], latencies[trial][2], latencies[trial][3])) 
        os.system('./Fittsi {} {} {} {} {} {}'.format(participant_id, trial, latencies[trial][0], latencies[trial][1], latencies[trial][2], latencies[trial][3]))
        os.system('echo "0 0 0 0" > /tmp/delaydaemon')
